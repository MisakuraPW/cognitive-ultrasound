...
export PREPARATION_CONFIG="${PREPARATION_CONFIG:-$PWD/configs/torch_casl.yaml}"
export PREPARATION_OUTPUT="${PREPARATION_OUTPUT:-/root/autodl-tmp/outputs_casl/torch_casl_v1}"
