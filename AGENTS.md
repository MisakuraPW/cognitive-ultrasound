...
- Current bounded preparation entry: `docs/preparation_closure.md`. Historical full reproduction and source-package instructions are not the default workflow.
